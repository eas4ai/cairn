...
findings:
  - resolved: --level is not validated; any value other than exactly Blocking silently loses the bypass, so a typo in the one flag that protects a Blocking decision is the worst place for silence
