...
goes to the backlog, and the agent may promote one into the next commitment
on its own, recording the decision for your review; an idea that would
change an agreed requirement or the working agreement waits for the next
feature specification, which you open. Neither is a place to park unfinished
