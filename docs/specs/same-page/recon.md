...
| No check verifies that a MAY requirement carries no Falsifier line, or that an Agreed MUST carries one | untested | LANG-070, LANG-073; ENG-024, ENG-025 | closed 2026-09-02 in iteration 003: CONF-016, CONF-017, CONF-018 |
