...
export async function refuseUnauthorizedProtected(cwd, log) {
  ...
  if (last.kind === 'init' && last.sha !== rootSha) {
    throw new AuthError(`cairn: ${last.sha} is a second record of kind init on refs/cairn/log; the init record is the log's first record and nothing else; this is a breach`);
  }
