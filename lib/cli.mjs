...
import { parseEscalateArgs, cliAnswer, cliReply, cliDispute, retiredBy, waitedBy } from './escalate.mjs';
...
const ARG_SPECS = {
  ...
  dispute: { flags: { '--commitment': 'value', '--record': 'value', '--n': 'repeatable', '--question': 'value', '--recommendation': 'value', '--because': 'value', '--if-wrong': 'value', '--instead': 'value' } },
  ...
  accept: { flags: { '--file': 'value' }, positionals: 1 },
  push: {},
  wake: {},
};
...
export const COMMANDS = {
  ...
  dispute: { usage: 'dispute --commitment <s> --record <sha> --n <n>[,<n>...] --question <q> --recommendation <r> --because <b> --if-wrong <w> --instead <i>', run: disputeCommand },
