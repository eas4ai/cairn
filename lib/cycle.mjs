...
import { progressSummary, progressMade, readState, verdictOf, ORDER, predicates } from './wake.mjs';
...
export const BOUNDS = Object.freeze({ sameTarget: 4, total: 28 });
...
// concerns are the fixed 'cycle' token, not a checked one). Sudus 4.0.0 removed the acceptance
// rounds and with them the bound on them (issue #23).
