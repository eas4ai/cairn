...
// Until Task 9 defines calibrate()/currentCalibration() for real, route mode always reads as
// uncalibrated; every route-mode test in this task exercises that "no calibration yet" branch.
export async function currentCalibration() { return null; }
