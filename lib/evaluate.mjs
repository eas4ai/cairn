...
//   crash before any call was made): finalized indeterminate with call: null.
...
export async function measure(cwd, draft, { transport = post } = {}) {
  ...
  const intentBase = { draft_digest: id.draft_digest, snapshot: id.ws, log_head: id.log_head,
    adr_digest: id.adr_digest, settings_digest: id.settings_digest, policy_digest: policyDigest(settings) };
