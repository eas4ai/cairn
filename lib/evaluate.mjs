...
async function loadSettingsFull(cwd) {
  let raw;
...
export function applyEnvelope(settings, { protectedReasons: prot = [], unavailable = null, optionAnswers: o = {}, ownerAnswer: w = null, optionCount = 0, optionOnly = false }) {
...
export async function evaluate(cwd, draft, { transport = post } = {}) {
  ...
  let optionReq, ownerReq, unavailable = null;
  try {
