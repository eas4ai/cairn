...
export const RESERVED = ['.sudus/**', 'docs/spec/**', 'docs/decisions.jsonl', 'AGENTS.md'];
export const PROTECTED = ['.sudus/settings.json', 'docs/spec/**', 'AGENTS.md'];
...
export const KERNEL_MANAGED = ['.sudus/mechanisms', '.sudus/mechanisms/**', 'docs/decisions.jsonl'];
