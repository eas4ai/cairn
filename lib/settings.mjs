...
// validates clean.
const SECRET_VALUE = /^(-----BEGIN|(sk|pk|tsk|ghp|gho|xox[abps])[-_][A-Za-z0-9_-]{10,}$|AKIA[0-9A-Z]{16}$|(?=[A-Za-z0-9_]{32,}$)(?=[A-Za-z0-9_]*[A-Za-z])(?=[A-Za-z0-9_]*[0-9])[A-Za-z0-9_]{32,}$|[A-Za-z0-9_-]{10,}\.[A-Za-z0-9_-]{10,}\.[A-Za-z0-9_-]{10,}$|(?=[A-Za-z0-9+/=_.-]{32,}$)(?=[A-Za-z0-9+/=_.-]*[A-Z])(?=[A-Za-z0-9+/=_.-]*[a-z])(?=[A-Za-z0-9+/=_.-]*[0-9])[A-Za-z0-9+/=_.-]{32,}$)/;
