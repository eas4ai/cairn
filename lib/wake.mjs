...
export async function wake(cwd, opts = {}) {
  ...
  // repair; it never guesses." Runs after the missing-refs check (both durable refs exist by this
  // point) and before the ordinary predicate loop, so a bypassing ordinary Git push that left a
  // gap is caught before wake tries to read state through it.
